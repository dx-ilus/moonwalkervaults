...
export default function App() {
  ...
  const DISCORD_OAUTH_URL =
    'https://discord.com/oauth2/authorize?client_id=1542916030685511740&redirect_uri=https://moonwalkervault.dpdns.org/api/auth/discord&response_type=code&scope=identify%20guilds';
